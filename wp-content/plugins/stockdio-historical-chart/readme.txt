...
4. Insert the `[stockdio-historical-chart]` shortcode into your post content, customizing it with the appropriate parameters. You also have the option to use the Stock Prices Chart widget included when you install the plugin.
